    ...
    internal sealed class ButtonsTester : IDisposable
    {
        ...
        public ButtonsTester()
        {
            subscriptions = new CompositeDisposable
            {
                ...
                Integration.AddButton("SamplePlugin: Open syrve.help", OpenSyrveSite),
        ...
        private static void OpenSyrveSite(IViewManager viewManager, IReceiptPrinter receiptPrinter)
        {
