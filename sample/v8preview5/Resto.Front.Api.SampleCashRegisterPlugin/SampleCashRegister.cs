...
namespace Resto.Front.Api.SampleCashRegisterPlugin
{
    internal sealed class SampleCashRegister : Devices.ICashRegister
    {
        ...
        /// <param name="zReportTask">Task for printing Z-report</param>
        /// <param name="user">The user who is printing</param>
        ...
        /// Call print X-report
        /// </summary>
		/// <param name="xReportTask">Task for printing X-report</param>
        /// <param name="cashier">The user who is printing</param>
        /// <returns>Returns an object <see cref="CashRegisterResult"/>
        /// Throw an exception on error
        /// </returns>
        ...
        /// </summary>
        /// <param name="printTextTask.Document">Document for printing (\\n)</param>
        ...
        /// </summary>
        /// <param name="openSessionTask">Task for opening a session on a cash register</param>
        ...
        /// </summary>
        /// <param name="payInTask">Task for depositing cash</param>
        /// <param name="cashier">Cashier</param>
        /// <returns>Returns an object  <see cref="CashRegisterResult"/>
        /// Throw an exception on error
        /// </returns>
        ...
        /// </summary>
        /// <param name="payOutTask">Task for cash withdrawal</param>
        /// <param name="cashier">Cashier</param>
        /// <returns>Returns an object<see cref="CashRegisterResult"/>
        /// Throw an exception on error
        /// </returns>
